...
\bigtitle{Vierge Marie, Mère de Providence, à Vigiles}{jeudi 9 juillet}{Vigiles}

\rubric{On chante trois fois:}
\gscore{or_dlm_ferialis}
...
\psalm{77-i}{1}
\smalltitle{Division}
\columnratio{0.54} %% retirer en cas de réutilisation, exceptionnel pour la mise en page
\psalm{77-ii}{1}

\gscore{an_propitius_esto}
\translation{\aa Sois indulgent pour nos péchés, Seigneur.}
\smalltitle{Psaume 78}
\psalm{78}{8}
\columnratio{0.5}
...
\noindent\includegraphics[height=\textheight]{photo_cecile_portrait.png}\thispagestyle{empty}
\restoregeometry

{\footnotesize\rubric{Page précédente: reliquaire de Sainte Cécile, basilique Sainte-Cécile de Rome, \copyright{} Jean-Michel Maillet. Sainte Cécile est la Reine de l'Harmonie.}}       
...
\vspace{5mm}
\gscore{an_alleluia_feria5_sineps} 
...
\vv D'heureuses paroles jaillissent de mon cœur quand je dis mes poèmes pour le roi.}
...
\rubric{Oraison des Vêpres, avec \normaltext{Orémus}, p. \pageref{0709_oratio}.}
...
{Quel que soit votre travail, faites-le de bon cœur, pour le Seigneur et non
...
\capitulum{Ga 4, 4-5}
{Ubi venit plenitúdo témporis, misit Deus Fílium
suum,~\pscross{} factum ex mulíere, factum sub lege,~\psstar{} ut eos, qui
sub lege erant, redímeret,~\pscross{} ut adoptiónem filiórum reciperémus.}
{Lorsqu’est venue la plénitude
des temps, Dieu a envoyé
son Fils, né d’une femme et soumis
à la loi de Moïse, afin de
racheter ceux qui étaient soumis
à la Loi et pour que nous soyons
adoptés comme fils.}
...
\incipit{magn}{6f}
\psalm{magn}{6}
\gscore{an_exsultavit_quia_fecit_sineeu}
