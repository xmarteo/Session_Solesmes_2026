...
\item Ierúsalem, quæ ædificáta \textbf{est} ut \textbf{cí}\textbf{vi}tas,~* sibi compácta \textbf{in} id\textbf{íp}sum.
...
\item Quia illic sedérunt sedes \textbf{ad} iu\textbf{dí}\textbf{ci}um,~* sedes \textbf{do}mus \textbf{Da}vid.

\item Rogáte, quæ ad pacem \textbf{sunt} Ie\textbf{rú}\textbf{sa}lem:~* « Secúri sint \textbf{di}li\textbf{gén}tes te!
