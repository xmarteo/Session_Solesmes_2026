...
\footnotesize{\rubric{Pages suivantes: David et Saül, parement conservé à l'abbaye de Solesmes, \copyright{} Jacques Baguenier. On attribue à David la création des psaumes. Le jeune David charmait par sa musique les inquiétudes du roi Saül.}}

\newpage

\newgeometry{scale=1, headsep=0mm}%
\noindent\includegraphics[height=\textheight]{photo_davidparement_paysage_gauche}\thispagestyle{empty}
\newpage
\noindent\includegraphics[height=\textheight]{photo_davidparement_paysage_droite}\thispagestyle{empty}
\restoregeometry
